...
/**
 * This class defines a JPanel that can display a respiration rate graph.
 * 
 * @author Pawel
 * 
 */
public class RespirationRateGraph extends JPanel{
	...
	/**
	 * Creates a new respiration rate graph.
	 * 
	 * @param graphTitle
	 *            This title will be displayed above the graph
	 * @param preferredDimension
	 */
	public RespirationRateGraph(String graphTitle, Dimension preferredDimension) {
		super();
	 ...
	 * @param value Respiration rate value
	 */
