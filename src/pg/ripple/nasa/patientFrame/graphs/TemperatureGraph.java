...
/**
 * This class defines a JPanel that can display a temperature graph.
 * 
 * @author Pawel
 * 
 */
public class TemperatureGraph extends JPanel{
	...
	/**
	 * Creates a new temperature graph.
	 * 
	 * @param graphTitle
	 *            This title will be displayed above the graph
	 * @param preferredDimension
	 */
	public TemperatureGraph(String graphTitle, Dimension preferredDimension) {
		super();
